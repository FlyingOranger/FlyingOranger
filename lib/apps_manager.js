...
exports.appInfo = (() => {
    ...
    for (var app_name in apps){
        ...
        // add default settings if they haven't been added by the user already
        if (typeof settings.app_specific[app_name][ "Disable completely" ] === "undefined")
            settings.app_specific[app_name][ "Disable completely" ] = false;
        
        if (typeof settings.app_specific[app_name][ "Disable flying notifications" ] === "undefined")
            settings.app_specific[app_name][ "Disable flying notifications" ] = false;
